...
class OrderController extends Controller
{
    ...
    public function makeOrderPost(Request $request, Menu $menus)
    {
        $rules = [
            'address' => 'required|max:255',
            'payment_method' => 'required|numeric',
            'quantity' => 'required|numeric|gt:0|lte:' . $menus->stock,
        ...
        $message = [
            ...
            'quantity.lte' => 'sorry the current available stock is ' . $menus->stock,
        ];
