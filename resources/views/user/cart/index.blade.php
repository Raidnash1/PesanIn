<x-guest-layout>
    ...
    <div class="container-lg">
        <div class="row px-xl-5 pt-5">
                        ...
                        <div class="row">
                            @foreach ($carts as $cart)
                                ...
                                <div class="col">
                                    ...
                                    <h5>{{ $cart->quantity }}</h5>
                                    <h5>Rp. {{ number_format($cart->menu->price * $cart->quantity, 2, ',', '.') }}</h5>
                                ...
                                <div class="col-3 position-relative">
                                    <div class="position-absolute top-50 end-0">
                                        ...
                                        <div class="number-input d-inline">
                                            <button class="btn btn-secondary" onclick="decrementValue()">
                                                << /button>
            ...
            <div class="col-lg-3">
                ...
                <h5 class="section-title position-relative mb-3"><span class="bg-light pe-3">Ringkasan Pesanan</span>
                </h5>
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button class="btn btn-warning px-5" data-bs-target="#exampleModalToggle"
    ...
    <div class="modal fade m-2" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle"
                        data-bs-toggle="modal">Lanjut</button>
                </div>
            </div>
        </div>
    </div> --}}
